...
import {
  ArrowLeft, Loader2, Building2, User as UserIcon, Save, Trash2, Plus, MessageSquare, FileText, Target, AlertCircle, CalendarClock, Phone, Database,
} from "lucide-react";
import {
    ...
    <div className="max-w-4xl mx-auto space-y-4">
      ...
      <Tabs defaultValue="general">
        <TabsList className="w-full justify-start overflow-x-auto">
          ...
          <TabsTrigger value="erp"><Database className="h-3.5 w-3.5 mr-1" />Histórico ERP</TabsTrigger>
        </TabsList>
